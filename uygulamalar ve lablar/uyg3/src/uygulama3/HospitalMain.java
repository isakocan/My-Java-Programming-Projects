...
public class HospitalMain {
	public static void main(String args[]) {
		...
		Treatment treatment1 = new Treatment("Painkillers", 7, 50.0);
		Treatment treatment2 = new Treatment("Antibiotics", 10, 100.0);
		
		System.out.println("***** Doctors *****");
		Hospital.showListDoctor(Doctor.getDoctorList());
