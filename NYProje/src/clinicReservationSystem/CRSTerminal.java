...
public class CRSTerminal {
	...
	public void run() {
		...
		do {
			...
			try {
				...
				System.err.println("Hata: Geçersiz bir tarih formatı. Lütfen GG-AA-YYYY formatında bir tarih girin");
	...
	private void makeAppointment(Scanner scanner) throws ParseException, IDException {
